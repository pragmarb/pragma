...
RSpec.describe Pragma::Resource::Macro::Policy do
  subject(:result) do
    ...
    before do
      ...
      module PolicyMacroTest
        ...
        class Operation < Pragma::Operation::Base
          ...
          step :model!
          step Pragma::Resource::Macro::Policy(), fail_fast: true
          step :finish!
    ...
    before do
      ...
      module PolicyMacroTest
        ...
        class Operation < Pragma::Operation::Base
          ...
          step :model!
          step Pragma::Resource::Macro::Policy(action: :custom_operation), fail_fast: true
          step :finish!
